...
public class bimrecord implements ActionListener{
JFrame frame, frame1;
JTextField textbox;
JLabel label;
JButton button;
...
label = new JLabel("Enter your Batch:");
label.setBounds(30, 30, 100, 20);
button = new JButton("search");
button.setBounds(120,100,150,20);
...
String sql = "select * from "+batch+" order by fname desc";
