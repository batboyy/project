...
public class biminsert extends JFrame implements ActionListener
  { 
        ...
        tf5.addKeyListener(new KeyAdapter(){
            public void keyPressed(KeyEvent e){
                ...
                if(Character.isDigit(ch)){
                    ...
                    JOptionPane.showMessageDialog(null, "Only number are allowed!");
                    tf5.setText(" ");
                }
            }
});
